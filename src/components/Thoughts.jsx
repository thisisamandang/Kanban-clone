  ...
  return (
    ...
    <div className="mt-14 flex xs:hidden ss:hidden md:flex  flex-col justify-center items-center mx-6">
      <div>
        <span className="">
          <svg
            className=" bg-[#f5f5f5] drop-shadow-3xl rounded-3xl"
            width="30"
            height="24"
            viewBox="0 0 24 24"
            fill="none"
      ...
      <div className="bg-[#f5f5f5] rounded-2xl px-5">
        <p className="font-medium text-center text-sm pt-3 pb-3">
          Thoughts Time
        </p>
        <p className="text-center font-normal text-xs pb-6">
          We don&apos;t have any notice for you, till then you can share your
          thoughts with your peers
        </p>
        <button className=" font-medium mb-8 lg:ml-5 sm:ml-2 ">
          Write a message
        </button>
      </div>
    </div>
